$(document).ready(function () {
    ...
    function fixMKTOFormButtons() {
        const btns = $("button[type='submit'].mktoButton");
        btns.each(function () {
            const self = $(this);
            self.addClass("global-cta");
            self.removeClass("mktoButton");

            const text = $('<p class="global-cta-text"></p>').text(self.text());
